...
####################################################################
pdf(paste(p_outdir,"dada2_plotQualityProfile.pdf",sep=""), onefile=T)
...
filtFs <- file.path(outdir, "filtered", paste(sample.names, "_F_filt.fastq.gz",sep=""))
filtRs <- file.path(outdir, "filtered", paste(sample.names, "_R_filt.fastq.gz",sep=""))
