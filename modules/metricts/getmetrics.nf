process getMetrics {
   ...
   docker run --cpus ${params.ncrs} -v \$PWD/metrics:/data -v "${params.refdir}":/ref  pipelinesinmegen/pipelines_inmegen:public \
   ...
   docker run --cpus ${params.ncrs} -v \$PWD/metrics:/data pipelinesinmegen/pipelines_inmegen:public \
